...
: ${AMENT_CURRENT_PREFIX:="/aichallenge/workspace/src/install/traj_follower_cpp"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/traj_follower_cpp/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/traj_follower_cpp/environment/path.sh"
